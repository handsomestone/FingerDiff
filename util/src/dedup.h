...
/*deduplication metadata block entry*/
typedef struct _dedup_metadata_block_entry{
	unsigned int superblock_id;
	unsigned int superblock_offset;
	unsigned int superblock_len;
} dedup_metadata_block_entry;
#define DEDUP_METADATA_BLOCK_ENTRY_SIZE  (sizeof(dedup_metadata_block_entry))
